        ...
        <main className="bg-primary max-w-7xl mx-auto">
          ...
          <div className="flex pb-20 pt-16">
            ...
            <div className="flex flex-col justify-center   mx-auto  px-4 text-center sm:px-8 lg:w-1/2 lg:py-48 xl:pr-16">
              <h1 className="text-4xl tracking-tight font-bold text-gray-900 text-left md:text-center lg:text-left sm:text-5xl md:text-6xl lg:text-5xl lg:text-left xl:text-6xl">
                <span className="block xl:inline">An app a day.</span>{' '}
                
              </h1>
              <p className="mt-3 max-w-md mx-auto text-lg text-left md:text-center lg:text-left text-gray-900 sm:text-xl md:mt-5 md:max-w-3xl lg:text-left lg:mx-0">
